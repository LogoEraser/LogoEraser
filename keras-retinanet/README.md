...
1) Create a model by calling for instance `keras_retinanet.models.RetinaNet` and compile it.
...
## Testing
An example of testing the network can be seen in [this Notebook](https://github.com/delftrobotics/keras-retinanet/blob/master/examples/RetinaNet%20-%20COCO%202017.ipynb).
